...
moduleForComponent('lds-navigation-bar-item', 'Integration | Component | lds navigation bar item', {
  integration: true
});

test('it renders', function(assert) {
  this.render(hbs`{{lds-navigation-bar-item}}`);
  
  assert.equal(this.$('.slds-context-bar__label-action').text().trim(), 'Menu Item');
});

test('it renders with text', function(assert) {
  this.render(hbs`{{lds-navigation-bar-item text='Events'}}`);
...
test('it renders with text and title', function(assert) {
  this.render(hbs`{{lds-navigation-bar-item text='Events' title='another title'}}`);
...
test('it renders with block and title', function(assert) {
  this.render(hbs`
    {{#lds-navigation-bar-item title='my title'}}
      Amazing Item
    {{/lds-navigation-bar-item}}
  `);
